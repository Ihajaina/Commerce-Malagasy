    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                // 2 : Envoyer un email à l'utilisateur avec un lien lui permettant de mettre à jour sont mot de passe.
                ...
                $content = "Bonjour ".$user->getFirstname()."<br/>Vous avez demandé à réinitialiser votre mot de passe sur le commerce Malagasy.<br/><br/>";
