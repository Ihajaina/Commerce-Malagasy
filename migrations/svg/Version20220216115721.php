 ...
 */
final class Version20220216115721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526CDE18E50B');
        $this->addSql('DROP INDEX IDX_9474526CDE18E50B ON comment');
        $this->addSql('DROP INDEX IDX_9474526C9D86650F ON comment');
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id_id INT NOT NULL, CHANGE product_id product_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C9D86650F FOREIGN KEY (user_id_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CDE18E50B FOREIGN KEY (product_id_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_9474526CDE18E50B ON comment (product_id_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526C9D86650F ON comment');
        $this->addSql('DROP INDEX IDX_9474526CDE18E50B ON comment');
        $this->addSql('ALTER TABLE comment CHANGE comment comment LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE user_id_id user_id INT NOT NULL, CHANGE product_id_id product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C9D86650F FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CDE18E50B FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_9474526C9D86650F ON comment (user_id)');
        $this->addSql('CREATE INDEX IDX_9474526CDE18E50B ON comment (product_id)');
