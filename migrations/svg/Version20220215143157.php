 ...
 */
final class Version20220215143157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id INT NOT NULL, CHANGE product_id product_id INT DEFAULT NULL');
